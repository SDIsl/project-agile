...
class ProjectTask (models.Model):
    ...
    is_user_story = fields.Boolean(string='Is history user', help=_('Mark if this taks is a user history'))
    ...
    scrum_team_id = fields.Many2one(related='scrum_sprint_id.team_id')
